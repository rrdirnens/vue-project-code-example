<template>
  <div class="header header--sticky">
    ...
    <div class="header__right">
      <a href="javascript:;" class="button header__button">Become a host</a>
      <a href="javascript:;" class="button header__button">
        <svg
          class="button__elem"
          viewBox="0 0 16 16"
      ...
      <button class="header__account-hamburger">
        ...
        <svg
          class="header__account-user-icon"
          viewBox="0 0 32 32"
          xmlns="http://www.w3.org/2000/svg"
          aria-hidden="true"
          role="presentation"
      ...
      <div v-if="hamburger" class="header__user-panel">
        <a href="javascript:;" class="header__user-panel-link">Log in</a>
        <a href="javascript:;" class="header__user-panel-link">Sign up</a>
        <div class="header__user-panel-divider"></div>
        <a href="javascript:;" class="header__user-panel-link"
          >Host your home</a
        >
        <a href="javascript:;" class="header__user-panel-link"
